<template>
    <div v-if="visible" class="notification-popup" :class="{ 'public-theme': isPublicPage }" @click="close" role="alert" aria-live="assertive">
...
const isPublicPage = computed(() => !userStore.getUser);
...
.notification-popup.public-theme {
