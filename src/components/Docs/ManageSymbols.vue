...
<div class="center-container">
  <h1>Managing Symbols in Watchlists</h1>
  <p>
  ...
  <ul>
    <li><b>Ticker:</b> Alphabetical order</li>
    <li><b>Last:</b> Highest price</li>
    <li><b>Chg:</b> Most numerical gain</li>
    <li><b>Chg%:</b> Highest percentage gain</li>
  </ul>
</div>
</template>
