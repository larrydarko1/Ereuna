<template>
    <div class="summary-row">
              <div class="category">{{ t('summary.ticker') }}</div>
              <div class="response">
                <span>{{ assetInfo.Symbol}}</span>
                <button v-if="assetInfo.Symbol" @click="copyToClipboard(assetInfo.Symbol)" class="copy-icon" :title="t('summary.copyToClipboard')">
