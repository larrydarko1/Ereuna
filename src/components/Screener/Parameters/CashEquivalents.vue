<template>
  <div :class="[showCashEquivalentsModel ? 'param-card-expanded' : 'param-card']">
    <div class="header">
      ...
      <label class="switch">
        <input type="checkbox" id="cash-equivalents-check" v-model="showCashEquivalentsModel" aria-label="Toggle Cash & Equivalents filter">
        <span class="slider"></span>
      </label>
    </div>
    
    <div class="content" v-if="showCashEquivalentsModel">
      <div class="input-group">
        <div class="input-wrapper">
          <label class="input-label">Minimum</label>
          <input class="input-field" id="left-ce" type="number" step="0.01" placeholder="0.00" aria-label="Cash & Equivalents minimum">
        </div>
        <div class="input-wrapper">
          <label class="input-label">Maximum</label>
          <input class="input-field" id="right-ce" type="number" step="0.01" placeholder="0.00" aria-label="Cash & Equivalents maximum">
        </div>
      </div>
      
      <div class="actions">
        <button class="btn btn-secondary" @click="emit('reset'); emit('update:showCashEquivalents', false)" aria-label="Reset Cash & Equivalents filter">
          Reset
        </button>
        <button class="btn btn-primary" @click="SetCashEquivalents()" aria-label="Set Cash & Equivalents filter">
          Apply
        </button>
      </div>
    </div>
