<template>
  <div :class="[showIPOInputsModel ? 'param-card-expanded' : 'param-card']">
    ...
    <div class="content" v-if="showIPOInputsModel">
      <div class="input-group">
        <div class="input-wrapper">
          <label class="input-label">From</label>
          <input class="input-field" id="left-ipo" type="date" aria-label="IPO Date from">
        </div>
        <div class="input-wrapper">
          <label class="input-label">To</label>
          <input class="input-field" id="right-ipo" type="date" aria-label="IPO Date to">
        </div>
      </div>
      
      <div class="actions">
        <button class="btn btn-secondary" @click="emit('reset'); emit('update:showIPOInputs', false)" aria-label="Reset IPO Date filter">
          Reset
        </button>
        <button class="btn btn-primary" @click="SetIpoDate()" aria-label="Set IPO Date filter">
          Apply
        </button>
      </div>
    </div>
