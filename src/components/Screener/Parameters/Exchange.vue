<template>
  <div :class="[ShowExchangeModel ? 'param-card-expanded' : 'param-card']">
    <div class="header">
      ...
      <label class="switch">
        <input type="checkbox" v-model="ShowExchangeModel" aria-label="Toggle Exchange filter">
        <span class="slider"></span>
      </label>
    </div>

    <div class="content" v-if="ShowExchangeModel">
      <div class="checkbox-group">
        <div class="checkbox-item" v-for="(exchange, index) in Exchanges" :key="index">
          <label class="checkbox-label" :for="`exchange-${index}`">
            <input
              :id="`exchange-${index}`"
              type="checkbox"
              v-model="selectedExchanges[index]"
              class="checkbox-input"
              :aria-label="'Select ' + exchange + ' exchange'"
            >
            <span class="checkbox-custom"></span>
            <span class="checkbox-text">{{ exchange }}</span>
          </label>
        </div>
      </div>
...
const ShowExchangeModel = computed({
