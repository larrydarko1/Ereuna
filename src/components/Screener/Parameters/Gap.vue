<template>
  <div :class="[showGapModel ? 'param-s1-expanded' : 'param-s1']">
          <div class="row">
            <div
              ...
              <svg class="question-img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                @mouseover="handleMouseOver($event, 'gap')" @mouseout="handleMouseOut" aria-label="Show info for Gap % parameter">
          ...
          <div style="border: none;" v-if="showGapModel">
            ...
            <div class="row">
              <button class="btns" style="float:right" @click="SetGapPercent()" aria-label="Set Gap % filter">
