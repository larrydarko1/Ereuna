<template>
  <div :class="[showIntrinsicValueModel ? 'param-s1-expanded' : 'param-s1']">
          <div class="row">
            <div
              ...
              <svg class="question-img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                @mouseover="handleMouseOver($event, 'iv')" @mouseout="handleMouseOut" aria-label="Show info for Intrinsic Value parameter">
          ...
          <div style="border: none;" v-if="showIntrinsicValueModel">
            ...
            <div class="row">
              <button class="btns" style="float:right" @click="SetIntrinsicValue()" aria-label="Set Intrinsic Value filter">
