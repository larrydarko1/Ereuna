...
<template>
  <div class="ml-RES" :style="{ minWidth: columnsMinWidth + 'px' }">
    ...
    <div class="ml-wlist-container" @scroll.passive="handleScroll4">
      <div
        id="ml-wlist"
      ...
      >
        <div style="min-width: 50px; position: relative;">
          ...
          <div class="ml-dropdown-menu">
            <div @click="hideStock(asset)" @click.stop style="display: flex; flex-direction: row; align-items: center; height: 14px;">
              <svg style="width: 15px; height: 15px; margin-right: 5px;" class="img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                  <g id="Edit / Hide">
        ...
        <div style="min-width: 70px;" class="ml-btsymbol">
          ...
          <span v-if="asset.isDuplicate" class="duplicate-asterisk">
            *
            <span class="tooltip2">
              {{ t('screenerComponents.appearsIn') }}
...
function handleScroll4(event: Event) {
  emit('scroll', event);
}
