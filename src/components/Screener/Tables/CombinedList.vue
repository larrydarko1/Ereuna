<template>
 <div class="ml-RES">
                              ...
                              <div class="ml-wlist-container" @scroll.passive="emitHandleScroll4">
                                <div id="ml-wlist"
                                  style="display: flex; flex-direction: row; width: 100vw; height: 35px; align-items: center;"
                                  tabindex="0" @keydown="emitHandleKeydown" @click="emitSelectRow(asset.Symbol)"
                                  ...
                                  <div style="min-width: 50px;; position: relative;">
                                    <button class="ml-dropdown-btn">
                                      <svg class="ml-img" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <div class="ml-dropdown-menu">
                                      <div @click="emitHideStock(asset)" @click.stop
                                        ...
                                        <div class="ml-nested-dropdown-menu">
                                          <div v-for="(ticker, index) in watchlist.tickers" :key="index"
                                            ...
                                            <label :for="'watchlist-' + index" class="ml-checkbox-label">
                                              <div @click.stop="emitToggleWatchlist(ticker, asset.Symbol)"
                                  ...
                                  <div style="min-width: 70px;" class="ml-btsymbol">
                                    {{ asset.Symbol }}
...
function emitToggleWatchlist(ticker, symbol) {
  emit('toggle-watchlist', { ticker, symbol });
}

function emitHideStock(asset) {
  emit('hide-stock', asset);
}

function emitSelectRow(symbol) {
  emit('select-row', symbol);
}

function emitHandleKeydown(event) {
  emit('keydown', event);
}

function emitHandleScroll4(event) {
  emit('scroll', event);
}
</script>
