<template>
  ...
  <h1 class="title">Routine Update in Progress</h1>
  <p class="message">We're just updating our financial data and formulas. Everything is fine, and we'll be back to normal soon.</p>
