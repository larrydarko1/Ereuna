<template>
  ...
  >
    ...
    <h1 class="title">Signups Temporarily Unavailable</h1>
    <p class="message">We’re sorry, but new account registrations are currently closed. Please check back soon!</p>
  </div>
</template>
