...
export const RANGE_FILTERS = [
    ...
    { key: 'market-cap', field: 'MarketCap', queryPath: 'MarketCapitalization', label: 'Market cap', bounds: { kind: 'derived' } },
    ...
    { key: 'ps-ratio', field: 'PS', queryPath: 'PriceToSalesRatioTTM', label: 'P/S ratio', bounds: { kind: 'derived' } },
    ...
    { key: 'intrinsic-value', field: 'IV', queryPath: 'IntrinsicValue', label: 'Intrinsic value', bounds: { kind: 'derived' } },
    ...
    { key: 'earnings-qoq', field: 'EarningsQoQ', queryPath: 'EarningsQoQ', label: 'Earnings growth QoQ', bounds: { kind: 'derived' } },
    { key: 'earnings-yoy', field: 'EarningsYoY', queryPath: 'EarningsYoY', label: 'Earnings growth YoY', bounds: { kind: 'derived' } },
    { key: 'revenue-qoq', field: 'RevQoQ', queryPath: 'RevQoQ', label: 'Revenue growth QoQ', bounds: { kind: 'derived' } },
    { key: 'revenue-yoy', field: 'RevYoY', queryPath: 'RevYoY', label: 'Revenue growth YoY', bounds: { kind: 'derived' } },
    { key: 'cagr', field: 'CAGR', queryPath: 'CAGR', label: 'CAGR', bounds: { kind: 'derived' } },
    { key: 'div-yield', field: 'DivYield', queryPath: 'DividendYield', label: 'Dividend yield', bounds: { kind: 'derived' } },

    // Fund-specific
    { key: 'net-expense-ratio', field: 'NetExpenseRatio', queryPath: 'netExpenseRatio', label: 'Net expense ratio', bounds: { kind: 'derived' } },

    // Balance sheet and margins — the most recent quarterly filing
    { key: 'roe', field: 'ROE', queryPath: 'quarterlyFinancials.0.roe', label: 'Return on equity', bounds: { kind: 'derived' } },
    { key: 'roa', field: 'ROA', queryPath: 'quarterlyFinancials.0.roa', label: 'Return on assets', bounds: { kind: 'derived' } },
    { key: 'current-ratio', field: 'currentRatio', queryPath: 'quarterlyFinancials.0.currentRatio', label: 'Current ratio', bounds: { kind: 'derived' } },
    { key: 'current-assets', field: 'assetsCurrent', queryPath: 'quarterlyFinancials.0.assetsCurrent', label: 'Current assets', bounds: { kind: 'derived' } },
    { key: 'current-liabilities', field: 'liabilitiesCurrent', queryPath: 'quarterlyFinancials.0.liabilitiesCurrent', label: 'Current liabilities', bounds: { kind: 'derived' } },
    { key: 'current-debt', field: 'debtCurrent', queryPath: 'quarterlyFinancials.0.debtCurrent', label: 'Current debt', bounds: { kind: 'derived' } },
    { key: 'cash-equivalents', field: 'cashAndEq', queryPath: 'quarterlyFinancials.0.cashAndEq', label: 'Cash and equivalents', bounds: { kind: 'derived' } },
    { key: 'free-cash-flow', field: 'freeCashFlow', queryPath: 'quarterlyFinancials.0.freeCashFlow', label: 'Free cash flow', bounds: { kind: 'derived' } },
    { key: 'profit-margin', field: 'profitMargin', queryPath: 'quarterlyFinancials.0.profitMargin', label: 'Profit margin', bounds: { kind: 'derived' } },
    { key: 'gross-margin', field: 'grossMargin', queryPath: 'quarterlyFinancials.0.grossMargin', label: 'Gross margin', bounds: { kind: 'derived' } },
    { key: 'debt-to-equity', field: 'debtEquity', queryPath: 'quarterlyFinancials.0.debtEquity', label: 'Debt to equity', bounds: { kind: 'derived' } },
    { key: 'book-value', field: 'bookVal', queryPath: 'quarterlyFinancials.0.bookVal', label: 'Book value', bounds: { kind: 'derived' } },
    ...
    { key: 'rs-score-1w', field: 'RSScore1W', queryPath: 'RSScore1W', label: 'RS score 1W', bounds: { kind: 'fixed', min: 1, max: 100 } },
    { key: 'rs-score-1m', field: 'RSScore1M', queryPath: 'RSScore1M', label: 'RS score 1M', bounds: { kind: 'fixed', min: 1, max: 100 } },
    { key: 'rs-score-4m', field: 'RSScore4M', queryPath: 'RSScore4M', label: 'RS score 4M', bounds: { kind: 'fixed', min: 1, max: 100 } },

    // Volume
    { key: 'avg-volume-1w', field: 'AvgVolume1W', queryPath: 'AvgVolume1W', label: 'Average volume 1W', bounds: { kind: 'derived' } },
    { key: 'avg-volume-1m', field: 'AvgVolume1M', queryPath: 'AvgVolume1M', label: 'Average volume 1M', bounds: { kind: 'derived' } },
    { key: 'avg-volume-6m', field: 'AvgVolume6M', queryPath: 'AvgVolume6M', label: 'Average volume 6M', bounds: { kind: 'derived' } },
    { key: 'avg-volume-1y', field: 'AvgVolume1Y', queryPath: 'AvgVolume1Y', label: 'Average volume 1Y', bounds: { kind: 'derived' } },
    { key: 'rel-volume-1w', field: 'RelVolume1W', queryPath: 'RelVolume1W', label: 'Relative volume 1W', bounds: { kind: 'derived' } },
    { key: 'rel-volume-1m', field: 'RelVolume1M', queryPath: 'RelVolume1M', label: 'Relative volume 1M', bounds: { kind: 'derived' } },
    { key: 'rel-volume-6m', field: 'RelVolume6M', queryPath: 'RelVolume6M', label: 'Relative volume 6M', bounds: { kind: 'derived' } },
    { key: 'rel-volume-1y', field: 'RelVolume1Y', queryPath: 'RelVolume1Y', label: 'Relative volume 1Y', bounds: { kind: 'derived' } },
    { key: 'adv-1w', field: 'ADV1W', queryPath: 'ADV1W', label: 'Average dollar volume 1W', bounds: { kind: 'derived' } },
    { key: 'adv-1m', field: 'ADV1M', queryPath: 'ADV1M', label: 'Average dollar volume 1M', bounds: { kind: 'derived' } },
    { key: 'adv-4m', field: 'ADV4M', queryPath: 'ADV4M', label: 'Average dollar volume 4M', bounds: { kind: 'derived' } },
    { key: 'adv-1y', field: 'ADV1Y', queryPath: 'ADV1Y', label: 'Average dollar volume 1Y', bounds: { kind: 'derived' } },

    // Price performance
    { key: 'change-today', field: 'todaychange', queryPath: 'todaychange', label: 'Change today', bounds: { kind: 'derived' } },
    ...
    { key: 'off-52w-high', field: 'PercOffWeekHigh', queryPath: 'percoff52WeekHigh', label: '% off 52-week high', bounds: { kind: 'derived' } },
    { key: 'off-52w-low', field: 'PercOffWeekLow', queryPath: 'percoff52WeekLow', label: '% off 52-week low', bounds: { kind: 'derived' } },
