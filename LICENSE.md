...
- **Fork and modify** — for personal learning projects only
- **Reference** — use in portfolios, technical interviews, and educational presentations
...
- You must retain all copyright notices and this license in any copies or substantial portions of the Software
...
- **TradingView Lightweight Charts** (Apache 2.0) - See [frontend/src/lib/charting/LICENSE](frontend/src/lib/charting/LICENSE)
...
**This software is not intended for production use in financial trading or investment decision-making. Use at your own risk.**
