...
import {
    ...
    detectTriangles,
} from '@/lib/lightweight-charts/pattern-detectors';
import { getPivots } from '@/lib/lightweight-charts/pattern-pivots';
import { type OHLCData, type PatternMatch, type PatternType } from '@/lib/lightweight-charts/pattern-types';
