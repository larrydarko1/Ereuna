...
import { TimeAxisViewRenderer } from '@/lib/charting/engine/renderers/time-axis-view-renderer';
...
export class SeriesPrimitiveWrapper<TSeriesAttachedParameters = unknown> {
    ...
    private _paneViewsCache: RendererCache<
        readonly ISeriesPrimitivePaneView[],
        readonly SeriesPrimitivePaneViewWrapper[]
    > | null = null;
    private _timeAxisViewsCache: RendererCache<
        readonly ISeriesPrimitiveAxisView[],
        readonly SeriesPrimitiveTimeAxisViewWrapper[]
    > | null = null;
    private _priceAxisViewsCache: RendererCache<
        readonly ISeriesPrimitiveAxisView[],
        readonly SeriesPrimitivePriceAxisViewWrapper[]
    > | null = null;
    private _priceAxisPaneViewsCache: RendererCache<
        readonly ISeriesPrimitivePaneView[],
        readonly SeriesPrimitivePaneViewWrapper[]
    > | null = null;
    private _timeAxisPaneViewsCache: RendererCache<
        readonly ISeriesPrimitivePaneView[],
        readonly SeriesPrimitivePaneViewWrapper[]
    > | null = null;
    ...
    public timeAxisViews(): readonly ITimeAxisView[] {
        ...
        const wrapper = base.map(
            (aw: ISeriesPrimitiveAxisView) => new SeriesPrimitiveTimeAxisViewWrapper(aw, timeScale),
        );
    ...
    public priceAxisViews(): readonly IPriceAxisView[] {
        ...
        const wrapper = base.map(
            (aw: ISeriesPrimitiveAxisView) => new SeriesPrimitivePriceAxisViewWrapper(aw, priceScale),
        );
    ...
    public autoscaleInfo(startTimePoint: TimePointIndex, endTimePoint: TimePointIndex): AutoscaleInfo | null {
        return (
            this._primitive.autoscaleInfo?.(startTimePoint as unknown as Logical, endTimePoint as unknown as Logical) ??
            null
        );
    }
