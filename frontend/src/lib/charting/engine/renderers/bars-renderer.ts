...
import { optimalBarWidth } from '@/lib/charting/engine/renderers/optimal-bar-width';
...
export class PaneRendererBars extends BitmapCoordinatesPaneRenderer {
    ...
    protected override _drawImpl({
        ...
        this._barLineWidth = this._data.thinBars
            ? Math.min(this._barWidth, Math.floor(horizontalPixelRatio))
            : this._barWidth;
