/**
 * The arrow marker shape, up and down.
 */
import { ceiledOdd } from '@/lib/charting/engine/helpers/mathex';
import { type Coordinate } from '@/lib/charting/engine/model/coordinate';
import { hitTestSquare } from '@/lib/charting/engine/renderers/markers/square';
