<template>
      ...
      >
        <div class="watchlist-dropdown-menu">
          ...
          >
            ...
            >
              <svg class="imgm" viewBox="0 0 16 16" fill="var(--color-text)" xmlns="http://www.w3.org/2000/svg">
  ...
  <button class="navbtn" @click="addWatchlist" v-b-tooltip.hover :title="t('watchlistComponent.addTickerTitle')" :aria-label="t('watchlistComponent.addTickerAriaLabel')">
      <svg class="img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4 12H20M12 4V20" stroke="var(--color-text)" stroke-width="1.944" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
      ...
      <div class="dropdown-vnav">
        <div class="watchlist-dropdown-menu2">
          <button class="dropdown-item" @click="AutoPlay" v-b-tooltip.hover title="Autoplay Watchlist" aria-label="Autoplay watchlist">
            <svg class="img4" viewBox="0 0 16 16" fill="var(--color-text)" xmlns="http://www.w3.org/2000/svg">
          ...
          <button class="dropdown-item" @click="showCreateWatchlistModal = true" v-b-tooltip.hover :title="t('watchlistComponent.createWatchlist')" :aria-label="t('watchlistComponent.createWatchlist')">
            <svg class="img4" viewBox="0 0 32.219 32.219" fill="var(--color-text)" xmlns="http://www.w3.org/2000/svg">
          ...
          <button class="dropdown-item" @click="showRenameWatchlistModal = true" v-b-tooltip.hover :title="t('watchlistComponent.renameWatchlist')" :aria-label="t('watchlistComponent.renameWatchlist')">
            <svg class="img4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 5H14M14 5H19M14 5V19M9 19H14M14 19H19" stroke="var(--color-text)" stroke-width="2"/>
              <path d="M11 9H4C2.89543 9 2 9.89543 2 11V15H11" stroke="var(--color-text)" stroke-width="2"/>
              <path d="M17 15H20C21.1046 15 22 14.1046 22 13V9H17" stroke="var(--color-text)" stroke-width="2"/>
            </svg>
          ...
          <button class="dropdown-item" @click="exportWatchlist" v-b-tooltip.hover :title="t('watchlistComponent.exportWatchlist')" :aria-label="t('watchlistComponent.exportWatchlist')">
            <svg class="img4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 16V4M12 16L8 12M12 16L16 12" stroke="var(--color-text)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <rect x="4" y="18" width="16" height="2" rx="1" fill="var(--color-text)"/>
            </svg>
  ...
  <rect transform="rotate(-45)" y="10.313708" x="-7" height="2" width="14" style="fill:var(--color-text);" />
            ...
            <div v-else class="empty-list-message">
              <svg fill="var(--color-text)" height="20px" width="20px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
