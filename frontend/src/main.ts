 ...
 *      BEFORE the router is installed, so the first route guard knows whether
 *      the user is signed in and no one sees the sign-in page on their way to
 *      the app.
 *   3. Only then is the router installed and the app mounted.
